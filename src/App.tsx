...
function App() {
  ...
  const modalRef = useClickOutside(() => setShowForm(false))
    ...
    <div className={`min-h-screen bg-gray-50 flex flex-col ${isDarkModeEnabled ? 'dark' : ''}`}>
      ...
      {showForm && (
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4' ref={modalRef}></div>
          <dialog open={showForm} className="fixed inset-0 bg-black bg-opacity-0 flex items-center justify-center z-50 p-4">
