...
data:
  ...
  // Add header comment
  if (deployments.length > 0 || daemonSets.length > 0 || customNamespaces.length > 0 || configMaps.length > 0 || secrets.length > 0 || dockerHubSecrets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || serviceAccounts.length > 0 || roles.length > 0 || clusterRoles.length > 0) {
  ...
  if (secrets.length > 0) {
    ...
    if (dockerHubSecrets.length > 0 || serviceAccounts.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (serviceAccounts.length > 0) {
    ...
    if (roles.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (roles.length > 0) {
    ...
    if (clusterRoles.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
